                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-10">
                                    <h2 class="title">Gestionar Estudiantes - <?php echo ($nombre);?></h2>
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="grid-width-100" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT d.StudentId, d.StudentName, 
CONCAT(e.ClassName, ' - ',e.ClassNameNumeric, ' - ',e.Section) as classes,
f.descripcion as horario, g.SubjectName as materia, a.estado
