                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="docente.php"><i class="fa fa-home"></i> Inicio</a></li>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Actualizar Resultados publicados</h5>
                                                </div>
                                            </div>
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Bien hecho!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                            <strong>Ha ocurriso un error, intentada de nuevo!!</strong> <?php echo htmlentities($error); ?>
                                        </div>
                                        <?php } ?>
...
$ret = "SELECT d.StudentId, d.StudentName, a.id,
        ...
        a.primer_corte, a.segundo_corte, a.tercer_corte, cuarta_corte, a.nota_final, a.estado
...
{  ?>
    ...
    <div class="form-group">
        <label for="default" class="col-sm-2 control-label">Primer Bimestre</label>
            <div class="col-sm-10">
    ...
    <div class="form-group">
        <label for="default" class="col-sm-2 control-label">Segundo Bimestre</label>
            <div class="col-sm-10">
    ...
    <div class="form-group">
        <label for="default" class="col-sm-2 control-label">Tercer Bimestre</label>
            <div class="col-sm-10">
    ...
    <div class="form-group">
        <label for="default" class="col-sm-2 control-label">Cuarto Bimestre</label>
            <div class="col-sm-10">
                <input type="text" name="cuarta_corte" class="form-control" id="cuarta_corte" value="<?php echo htmlentities($row->tercer_corte);?>" maxlength="4"  autocomplete="off">
            </div>
    </div>  
...
<?php } }?>
        ...
        <a href="manage-results_doc.php" class="btn btn-danger">Cancelar</a>
        </div>
        </div>
        </form>
