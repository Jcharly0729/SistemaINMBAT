                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Ver lista de materias del Estudiantes</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
$sql ="SELECT c.ClassName, c.Section, h.descripcion, sj.SubjectName, ca.Status FROM tblclasses_asignacion ca INNER JOIN tblclasses c on c.id = ca.classes_id  INNER JOIN tblhorario h on h.id = ca.horario_id INNER JOIN tblsubjects sj on sj.id = ca.subject_id INNER JOIN tblteacher t on t.idTeacher = ca.teacher_id WHERE t.idTeacher = $stid and ca.Status =1"; //escuela
