...
f.descripcion as horario, g.SubjectName as materia, a.estado, a.primer_corte, a.segundo_corte, a.tercer_corte, a.cuarta_corte, a.nota_final
...
WHERE b.teacher_id = '$DocenteId' and c.Estado = 1";
...
<a href="edit-result_doc.php?id=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record">Modificar</i> </a> 
