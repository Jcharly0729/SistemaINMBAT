                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Revisar Pagos</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Pagos</li>
            							<li class="active">Revisar Pagos</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Ver Información de Pagos - <?php echo ($nombre); ?></h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
<?php 
    ...
    $sql ="SELECT a.idPension, a.FechaPension, a.MontoPension, b.costo_pagar, b.costo_pagado, b.Estado, a.Status
    FROM tblpensiones a 
    INNER JOIN tblinscripcion_matricula b on a.inscripcion_matricula_id = b.id
    WHERE a.inscripcion_matricula_id = (SELECT x.id FROM tblinscripcion_matricula x 
    where x.student_id = '$StudentId' and x.Estado = 1) and a.Status = 1"; //escuela
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <?php $pagar = $result->costo_pagar;?>
                                                            <?php $pago = $result->costo_pagado;?>                                                                                                                   
...
<?php $cnt=$cnt+1;}} ?>
                                                    ...
                                                    <strong><?php if($pagar >0){ echo("Monto a pagar: ". $pagar. " - Monto Pagado: ". $pago);}?></strong>
                                                </table>
