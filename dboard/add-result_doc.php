...
if(strlen($_SESSION['DocenteId'])=="")
    ...
    $sql="UPDATE tblcalificaciones a SET a.tercer_corte = '$nota' WHERE a.id = '$calificacionid'";
        $query = $dbh->prepare($sql);        
        $query->execute();            
        if($query->rowCount() > 0)
        {
        ...
        else 
        {
            ...
            $sql="UPDATE tblcalificaciones a SET a.cuarta_corte = '$nota',
             a.nota_final = (select ((a.primer_corte + a.segundo_corte+ a.tercer_corte+ $nota)/4) as nota ), a.estado = 2 
   ...
   <div class="main-page">
     <div class="container-fluid">
        <div class="row page-title-div">
           <div class="col-md-10">
              <h2 class="title">Registrar Calificaciones - <?php echo ($nombre);?></h2></div>
                                <!-- /.col-md-6 text-right -->
                            </div>
                            <!-- /.row -->
...
<?php } ?>
    <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
            <label for="date" class="col-sm-2 control-label ">calificaciones por bimestre</label>
            <div class="col-sm-8">
                <select name="corte" class="form-control" id="default" required="required">
                    ...
                    <option value="4" class="fadeIn">Cuarto Bimestre</option>                
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">    
                <input type="number" name="nota"  class="form-control" id="default" placeholder="calificacion en base 5" required>
            </div>           
        </div>
