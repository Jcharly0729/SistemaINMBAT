...
if($password == $_SESSION['pass'] && $newpassword == $confirmpassword)
{
$con="update tblteacher set Pass=:newpassword where User=:username";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':username', $username, PDO::PARAM_STR);
$chngpwd1-> bindParam(':newpassword', $newpassword, PDO::PARAM_STR);
$chngpwd1->execute();
$msg="Su contraseña cambió con éxito";
}
else {
...
<html lang="en">
    <head>
        ...
        <title>Cambio de Contraseña de Administrador</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Cambio de Contraseña de Administrador</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Cambio de Contraseña de Administrador</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Cambio de Contraseña de Administrador</h5>
                                                </div>
                                            </div>
           <?php if($msg){?>
 ...
 <strong>Bien hecho!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                    ...
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Confirmar Nueva Contraseña</label>
                                                        <div class="">
