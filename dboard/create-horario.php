...
if($rol == 1) {    
    $sql="INSERT INTO  tblhorario(descripcion, rol_id) VALUES(:horario, 7)";
}else {
    $sql="INSERT INTO  tblhorario(descripcion, rol_id) VALUES(:horario, 8)";
}
...
if($lastInsertId)
{
$msg="Horario creado exiotasamente";
}
else 
{
...
<div class="main-page">
 <div class="container-fluid">
  <div class="row page-title-div">
   <div class="col-md-6">
   <h2 class="title">Añadir Horario</h2></div></div>
                            <!-- /.row -->
 ...
 <div class="col-md-6">
  <ul class="breadcrumb">
   <li><a href="admin.php"><i class="fa fa-home"></i> Inicio</a></li>
    ...
    <li class="active">Añadir Horario</li></ul></div></div></div>
...
<div class="panel-body">
 <form method="post">
  ...
  <div class="">
   <input type="text" name="horario" class="form-control" required="required" id="success">
   <span class="help-block">Ejemplo - Lunes de 8:00 am a 9:30 am</span></div></div>
